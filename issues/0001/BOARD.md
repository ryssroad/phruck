# Issue 0001 Editorial Board

Status board for phruck 0001. This file is the issue-local state; GitHub Issues are the task board; AgentMail is transport.

## Gate

```text
Autonomy: Level 0/1
Publish: road required
Repo: public
Risk posture: no private mail excerpts in publishable text without road gate
```
...
- [ ] risk gate is explicit for every piece;
- [ ] road has a clean approve/veto/redirect packet.
